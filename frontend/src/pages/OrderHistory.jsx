...
//           /* Empty */
//           ) : orders.length === 0 ? (
//             <div className="flex flex-col items-center justify-center bg-white border border-gray-100 rounded-3xl py-24 text-center shadow-sm">
//               <div className="w-20 h-20 bg-gray-100 rounded-2xl flex items-center justify-center mb-5 text-4xl">
//                 📦
//               </div>
...
//                 <div
//                   key={order._id}
//                   className="bg-white border border-gray-100 hover:border-gray-200 hover:shadow-md rounded-3xl overflow-hidden transition-all duration-200"
//                 >
//                   {/* Order Header */}
//                   <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-5 sm:px-6 py-4 border-b border-gray-100 bg-gray-50/60">
//                     <div className="flex items-center gap-3 flex-wrap">
//                       {/* Order number */}
//                       <span className="bg-gray-900 text-white text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full">
//                         Order #{idx + 1}
//                       </span>
//                       {/* Date */}
...
//                       >
//                         {/* Image */}
//                         <div className="w-16 h-16 sm:w-[72px] sm:h-[72px] rounded-2xl overflow-hidden bg-gray-100 border border-gray-100 shrink-0">
//                           <img
...
//                   {/* Order Footer */}
//                   <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 px-5 sm:px-6 py-3.5 bg-gray-50/60 border-t border-gray-100">
