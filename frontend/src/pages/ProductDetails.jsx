          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="relative overflow-hidden bg-gray-100 min-h-[250px] sm:min-h-[300px] md:min-h-[480px]">
                ...
                <span className={`absolute top-3 right-3 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-full ${
              ...
              <div className="p-5 sm:p-8 flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-xs sm:text-sm text-gray-400">({product.numReviews} reviews)</span>
                  </div>
