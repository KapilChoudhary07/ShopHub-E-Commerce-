...
//               className="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm px-4 py-2.5 rounded-xl outline-none placeholder-gray-300 focus:bg-white focus:border-gray-400 focus:ring-2 focus:ring-gray-100 transition-all duration-150"
...
//                 className="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm px-4 py-2.5 pr-11 rounded-xl outline-none placeholder-gray-300 focus:bg-white focus:border-gray-400 focus:ring-2 focus:ring-gray-100 transition-all duration-150"
...
//           <button
//             onClick={submit}
//             className="w-full mt-6 bg-gray-950 text-white font-bold text-sm py-3 rounded-xl hover:bg-gray-700 active:scale-95 transition-all duration-150"
//           >
//             Sign In
//           </button>
...
//   className="w-full flex items-center justify-center gap-3 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-semibold text-sm py-2.5 rounded-xl transition-all duration-150 active:scale-95"
// >
//   <GoogleIcon />
