...
//               : "bg-white text-gray-400 hover:text-red-500 hover:scale-110 opacity-0 group-hover:opacity-100"
//           }`}
//         >
...
//         {/* Name */}
//         <h2 className="font-bold text-gray-900 text-base leading-snug line-clamp-1 mb-1">
//           {product.name}
//         </h2>
...
//           <p className="text-gray-950 font-black text-lg leading-none">
//             ₹{product.price?.toLocaleString("en-IN")}
//           </p>

//           <button
//             onClick={() => addItem(product._id)}
//             className="flex items-center gap-2 bg-gray-950 text-white text-xs font-semibold px-4 py-2.5 rounded-xl hover:bg-gray-700 active:scale-95 transition-all duration-150"
//           >
